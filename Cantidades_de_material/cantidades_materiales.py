...
# =====================================================================
#  3-quater-bis. AJUSTE DE ALTURA DE POSTE (reemplazo del "" en materiales
...
def extraer_altura_poste(tipo_soporte) -> Optional[str]:
    """
    Deduce la altura del poste (en metros, como texto p.ej. "14") a partir
    ...
    Devuelve None (en vez de lanzar una excepción) cuando:
      ...
      * `extraer_datos_poste` no reconoce el formato "PH ##/####" en el texto.
...
def extraer_pat_planilla(
    ...
    poste (p.ej. "14"), deducida de `col_tipo_soporte` mediante
    ...
    for idx, fila in est_df.iterrows():
        ...
        registros.append({
            ...
            "tipo_armado": "SPT",
            "armado": codigo_armado,
            # Altura del poste (p.ej. "14"), usada para reemplazar el "" en
